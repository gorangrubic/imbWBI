// --------------------------------------------------------------------------------------------------------------------
// <copyright file="tfidfFVExtractorSettings.cs" company="imbVeles" >
//
...
{
    /// <summary>
    /// Settings for <see cref="tfidfFVExtractor"/>
    /// </summary>
    /// <seealso cref="imbWBI.Core.WebClassifier.wlfClassifier.FVExtractorSettingsBase" />
    public class tfidfFVExtractorSettings : FVExtractorSettingsBase
    {
        public tfidfFVExtractorSettings()
        {
