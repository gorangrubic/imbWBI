// --------------------------------------------------------------------------------------------------------------------
// <copyright file="DocumentSetCase.cs" company="imbVeles" >
//
...
namespace imbWBI.Core.WebClassifier.cases
{
    ...
    /// <summary>
    /// Represents single case that is about to be evaluated
    /// </summary>
    public class DocumentSetCase
    {

       


        public documentSetCaseRole role { get; set; } = documentSetCaseRole.none;

        public WebClassifierResultSet data { get; set; } 

        
        public pipelineTaskMCSiteSubject subject { get; set; }

        public IWebFVExtractorKnowledge caseKnowledge { get; set; }
