// --------------------------------------------------------------------------------------------------------------------
// <copyright file="documentSetCaseRole.cs" company="imbVeles" >
//
...
namespace imbWBI.Core.WebClassifier.cases
{
    ...
    public enum documentSetCaseRole
    {
        none,
        /// <summary>
        /// The training: this case will be used as model training resource
        /// </summary>
        training,
        /// <summary>
        /// The evaluation: this case will be used as model evaluation resource
        /// </summary>
        evaluation,
    }
