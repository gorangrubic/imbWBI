// --------------------------------------------------------------------------------------------------------------------
// <copyright file="IWrapperModelGraph.cs" company="imbVeles" >
//
...
namespace imbWBI.Core.WebHarvester.wrapper
{
    ...
    public interface IWrapperModelGraph:IGraphNode
    {
        String description { get; set; }
        String XPath { get; set; }
        WrapperTypeEnum type { get; set; }
        IWrapperModelGraph modelRoot { get; }
        IWrapperModelGraph modelParent { get; }
