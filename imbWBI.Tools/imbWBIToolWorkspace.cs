// --------------------------------------------------------------------------------------------------------------------
// <copyright file="imbWBIToolWorkspace.cs" company="imbVeles" >
//
...
namespace imbWBI.Tools
{
    ...
    public class imbWBIToolWorkspace : aceAdvancedConsoleWorkspace
    {


        /// <summary>
        /// Initializes the workspace for the imbWBITool console 
        /// </summary>
        /// <param name="console">The console using this workspace</param>
        public imbWBIToolWorkspace(imbWBIToolConsole console) : base(console)
        {
